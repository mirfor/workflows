# Generated from Blueprint demo/order-flow-test v1 at 2026-05-11T12:06:12+00:00
# Source hash: 0be7293b0243431a94ec9041ec37290f75c9061d6306c68d7d2b2ba091227525
...
@workflow.defn(name="order-flow-test")
class OrderFlowTest_v1:

    @workflow.run
    async def run(self, input: dict[str, Any]) -> dict[str, Any]:
        steps_output: dict[str, Any] = {}
        ctx: dict[str, Any] = {"input": input, "steps": steps_output}
        l = await workflow.execute_activity(
